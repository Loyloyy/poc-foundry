...
def main(argv: list[str]) -> int:
    targets = [Path(a) for a in argv[1:]] or [
        ...
        _REPO / "tests" / "test_m2b_budget.py",
        _REPO / "tests" / "test_m2b_salvage.py",
        ...
        _REPO / "tests" / "test_m2c_research.py",
        _REPO / "tests" / "test_m2c_template_ci.py",
        _REPO / "tests" / "test_m3_events.py",
        _REPO / "tests" / "test_m4_refine.py",
        _REPO / "tests" / "test_m4_security.py",
        _REPO / "tests" / "test_m5_pilot.py",
        _REPO / "tests" / "test_m6_diagnostics.py",
        _REPO / "tests" / "test_m7_rehab.py",
    ]
    tp = tf = 0
    for t in targets:
        if not t.exists():
